...
public final class LeakCanary {
  ...
  public static String leakInfo(Context context, HeapDump heapDump, AnalysisResult result,
    ...
    if (result.leakFound) {
      ...
      // the stacktrace.
      info += "* FAILURE in " + DisplayLeakActivity.LIBRARY_VERSION + " " + DisplayLeakActivity.GIT_SHA + ":" + Log.getStackTraceString(
          result.failure) + "\n";
    } else {
      info += "* NO LEAK FOUND.\n\n";
    }
    ...
    info += "* Reference Key: "
        ...
        + " LeakCanary: "
        + DisplayLeakActivity.LIBRARY_VERSION
        + " "
        + DisplayLeakActivity.GIT_SHA
        + "\n"
        + "* Durations: watch="
